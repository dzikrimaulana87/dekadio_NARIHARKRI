                    ...
                    <div class="card">
                        <div class="container-fluid d-flex p-3" style="background-color: #530FAA; border-radius: 50px;">
                            <div class="w-25 d-flex justify-content-center align-items-center"
                                style="width: 215px; height: 215px; border-radius: 999px; background-color: tomato; overflow: hidden;">
                                <img src="https://firebasestorage.googleapis.com/v0/b/dekadio.appspot.com/o/users%2Fprofile-pictures%2Fchara.0-2790378180___-removebg-preview.png?alt=media&token=ec7fa8cc-cc57-4af6-b39c-6b591671e613" alt="img" class="img-fluid" style="border-radius: 999px;">
                            </div>

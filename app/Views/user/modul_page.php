    ...
    <div class="container-fluid">
        <nav
            ...
            <div class="w-75 h-100 me-5 text-center">
                ...
                <div>
                    <a href="<?= base_url('/modul-page') ?>" class="me-5"
                        style="color: #530FAA; border-bottom: solid #530FAA 3px;">Module</a>
                    <a href="<?= base_url('/vid-page') ?>" class="ms-5" style="color: #530FAA;">Video</a>
                </div>
            </div>
            ...
            <div class="w-75 d-flex justify-content-center">
                <div class="" style="margin-left: 100px;">
                    <div class="d-flex gap-3 justify-content-center align-items-center">
                        ...
                        <button class="btn btn-info" style="height: 50px;">Read</button>
                    </div>
                    <div class="d-flex gap-3 justify-content-center align-items-center">
                        <div class="">
                            <img src="https://firebasestorage.googleapis.com/v0/b/dekadio.appspot.com/o/course%2Fmodule%2FOIG.jpg?alt=media&token=e45b7b51-0c21-4c43-af15-9056ba0427b7"
